...
<head>
    ...
    <style>
        * { box-sizing: border-box; font-family: 'Plus Jakarta Sans', sans-serif; }
        body { margin: 0; background: #f5faf8; color: #234047; }
        .vendor-page { max-width: 1240px; margin: 0 auto; padding: 34px; }
        ...
        .page-head p { margin: 6px 0 0; color: #5b7378; }

        .alert { padding: 14px 16px; border-radius: 14px; margin-bottom: 16px; font-weight: 700; }
        .alert.ok { background: #e7f7ef; color: #24734d; }
        .alert.err { background: #fff0f0; color: #a13a3a; }
        ...
        label { font-size: 13px; font-weight: 800; color: #45666d; }
        ...
        .btn:hover { background: #5aa093; }
        .btn.danger { background: #e56b6f; }
        .btn.secondary { background: #94CDD3; color: #234047; }

        table { width: 100%; border-collapse: collapse; }
        th, td { padding: 14px 12px; border-bottom: 1px solid #edf5f2; text-align: left; vertical-align: middle; }
        th { color: #5b7378; font-size: 13px; }
        td strong { color: #234047; }
        .stock { font-weight: 800; color: #4f9186; }
